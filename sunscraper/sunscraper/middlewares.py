...
class SunscraperSpiderMiddleware:
...
class SunscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
# getting and deploying new user agent from scrape ops
...
# getting and deploying new header from scrape ops
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):        
        ...
        # need to delete some of below, as appropriate, as not all may be required for website
